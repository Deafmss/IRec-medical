  ...
  if (isClinician) {
    return (
      <div style={{ padding: '60px 24px', maxWidth: '520px', margin: '0 auto', textAlign: 'center' }}>
        <div className="glass-card glass-card-emerald-glow" style={{ padding: '32px 24px', borderRadius: '20px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' }}>
          ...
          <p style={{ fontSize: '13.5px', color: 'var(--text-muted)', lineHeight: '1.55', margin: 0 }}>
            A busca e agendamento de enfermagem domiciliar é destinada a pacientes. Como profissional credenciado, gerencie seus atendimentos e parcerias em <strong>Minhas Parcerias</strong>.
          </p>
          <button
            type="button"
          ...
          .map(doc => {
            ...
            return (
              <div 
                ...
                className="glass-card glass-card-emerald-glow" 
                style={{ 
                  padding: '24px', 
                  display: 'flex', 
              ...
              >
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: '11.5px', color: '#10b981', fontWeight: '700', margin: '3px 0 0 0', display: 'flex', alignItems: 'center', gap: '4px' }}>
                        🩺 {doc.specialty}
                      </p>
                    </div>
                  </div>
                ...
                {/* Price Display */}
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: 'rgba(16, 185, 129, 0.06)', padding: '10px 14px', borderRadius: '14px', border: '1px solid var(--glass-border)' }}>
                  <span style={{ fontSize: '11px', color: 'var(--text-muted)', fontWeight: '700' }}>Visita Domiciliar:</span>
                  <span style={{ fontSize: '13px', fontWeight: '800', color: '#10b981', fontFamily: 'var(--font-display)' }}>
