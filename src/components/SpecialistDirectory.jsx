            ...
            <div style={{
              ...
              <div style={{ flex: 1, overflowY: 'auto', padding: '24px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <div style={{
                  ...
                  <div>
                    <p style={{ fontSize: '13px', fontWeight: '800', margin: 0 }}>Profissional de Saúde Verificado iRec</p>
                    <p style={{ fontSize: '11px', margin: '2px 0 0 0', opacity: 0.9 }}>Registro profissional ativo no Conselho com Habilitação Clínica.</p>
                  </div>
                </div>
